...
## [0.4.21](https://github.com/0xethsign/arbiter/compare/arbiter-v0.4.20...arbiter-v0.4.21) - 2024-06-10

### Added
- environment logs ([#911](https://github.com/0xethsign/arbiter/pull/911))
- `error!` output from behavior ([#913](https://github.com/0xethsign/arbiter/pull/913))
- *(engine)* optional stream for behaviors ([#899](https://github.com/0xethsign/arbiter/pull/899))
- template as submodule ([#887](https://github.com/0xethsign/arbiter/pull/887))
- deprecate init ([#886](https://github.com/0xethsign/arbiter/pull/886))
- *(arbiter-macros)* `#[arbiter_macros::main]` and a project example ([#880](https://github.com/0xethsign/arbiter/pull/880))
- *(arbiter-core)* stream with meta ([#863](https://github.com/0xethsign/arbiter/pull/863))
- add agent builder
- `ArbiterInspector`
- console log works
- `World::stop()` method
...
### Fixed
- fix CI issues prior to release ([#861](https://github.com/0xethsign/arbiter/pull/861))
...
### Other
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 ([#965](https://github.com/0xethsign/arbiter/pull/965))
- *(deps)* bump serde from 1.0.198 to 1.0.200 ([#964](https://github.com/0xethsign/arbiter/pull/964))
...
- *(deps)* bump rustls from 0.21.10 to 0.21.11 in /docs in the cargo group across 1 directory ([#957](https://github.com/0xethsign/arbiter/pull/957))
- *(deps)* bump rustls from 0.21.10 to 0.21.11 in the cargo group ([#956](https://github.com/0xethsign/arbiter/pull/956))
- *(deps)* bump serde_json from 1.0.115 to 1.0.116 ([#955](https://github.com/0xethsign/arbiter/pull/955))
- *(deps)* bump chrono from 0.4.37 to 0.4.38 ([#954](https://github.com/0xethsign/arbiter/pull/954))
- *(deps)* bump serde from 1.0.197 to 1.0.198 ([#953](https://github.com/0xethsign/arbiter/pull/953))
- *(deps)* bump quote from 1.0.35 to 1.0.36 ([#947](https://github.com/0xethsign/arbiter/pull/947))
- *(deps)* bump anyhow from 1.0.81 to 1.0.82 ([#946](https://github.com/0xethsign/arbiter/pull/946))
- *(deps)* bump async-trait from 0.1.79 to 0.1.80 ([#948](https://github.com/0xethsign/arbiter/pull/948))
- *(deps)* bump syn from 2.0.58 to 2.0.60 ([#952](https://github.com/0xethsign/arbiter/pull/952))
- *(deps)* bump h2 from 0.3.24 to 0.3.26 in /docs ([#945](https://github.com/0xethsign/arbiter/pull/945))
- *(deps)* bump h2 from 0.3.25 to 0.3.26 ([#944](https://github.com/0xethsign/arbiter/pull/944))
- *(deps)* bump syn from 2.0.57 to 2.0.58 ([#943](https://github.com/0xethsign/arbiter/pull/943))
- db management ([#922](https://github.com/0xethsign/arbiter/pull/922))
- *(deps)* bump async-trait from 0.1.77 to 0.1.79 ([#940](https://github.com/0xethsign/arbiter/pull/940))
- *(deps)* bump thiserror from 1.0.57 to 1.0.58 ([#941](https://github.com/0xethsign/arbiter/pull/941))
- *(deps)* bump tokio-stream from 0.1.14 to 0.1.15 ([#939](https://github.com/0xethsign/arbiter/pull/939))
- *(deps)* bump serde_json from 1.0.114 to 1.0.115 ([#938](https://github.com/0xethsign/arbiter/pull/938))
- *(deps)* bump mio from 0.8.10 to 0.8.11 in /docs ([#927](https://github.com/0xethsign/arbiter/pull/927))
- *(deps)* bump anyhow from 1.0.80 to 1.0.81 ([#933](https://github.com/0xethsign/arbiter/pull/933))
- *(deps)* bump proc-macro2 from 1.0.78 to 1.0.79 ([#934](https://github.com/0xethsign/arbiter/pull/934))
- *(deps)* bump toml from 0.8.10 to 0.8.12 ([#935](https://github.com/0xethsign/arbiter/pull/935))
- *(deps)* bump rayon from 1.8.1 to 1.10.0 ([#937](https://github.com/0xethsign/arbiter/pull/937))
- update submodule ([#928](https://github.com/0xethsign/arbiter/pull/928))
- Update README.md ([#936](https://github.com/0xethsign/arbiter/pull/936))
- *(deps)* bump ethers from 2.0.13 to 2.0.14 ([#931](https://github.com/0xethsign/arbiter/pull/931))
- *(deps)* bump clap from 4.5.1 to 4.5.2 ([#929](https://github.com/0xethsign/arbiter/pull/929))
- *(deps)* bump chrono from 0.4.34 to 0.4.35 ([#930](https://github.com/0xethsign/arbiter/pull/930))
- *(deps)* bump mio from 0.8.10 to 0.8.11 ([#926](https://github.com/0xethsign/arbiter/pull/926))
- *(deps)* bump crossbeam-channel from 0.5.11 to 0.5.12 ([#919](https://github.com/0xethsign/arbiter/pull/919))
- *(deps)* bump syn from 2.0.51 to 2.0.52 ([#920](https://github.com/0xethsign/arbiter/pull/920))
- *(deps)* bump tempfile from 3.10.0 to 3.10.1 ([#917](https://github.com/0xethsign/arbiter/pull/917))
- *(deps)* bump syn from 2.0.50 to 2.0.51 ([#915](https://github.com/0xethsign/arbiter/pull/915))
- release ([#914](https://github.com/0xethsign/arbiter/pull/914))
- release ([#905](https://github.com/0xethsign/arbiter/pull/905))
- *(deps)* bump serde from 1.0.196 to 1.0.197 ([#910](https://github.com/0xethsign/arbiter/pull/910))
- *(deps)* bump syn from 2.0.49 to 2.0.50 ([#908](https://github.com/0xethsign/arbiter/pull/908))
- *(deps)* bump serde_json from 1.0.113 to 1.0.114 ([#909](https://github.com/0xethsign/arbiter/pull/909))
- *(deps)* bump assert_cmd from 2.0.13 to 2.0.14 ([#907](https://github.com/0xethsign/arbiter/pull/907))
- *(deps)* bump anyhow from 1.0.79 to 1.0.80 ([#906](https://github.com/0xethsign/arbiter/pull/906))
- *(deps)* bump arbiter-engine from 0.2.0 to 0.3.0 ([#902](https://github.com/0xethsign/arbiter/pull/902))
- *(deps)* bump clap from 4.5.0 to 4.5.1 ([#903](https://github.com/0xethsign/arbiter/pull/903))
- *(deps)* bump syn from 2.0.48 to 2.0.49 ([#901](https://github.com/0xethsign/arbiter/pull/901))
- incorrect method ([#904](https://github.com/0xethsign/arbiter/pull/904))
- release ([#896](https://github.com/0xethsign/arbiter/pull/896))
- refactor engine tests and examples ([#895](https://github.com/0xethsign/arbiter/pull/895))
- *(arbiter)* release v0.4.16 ([#894](https://github.com/0xethsign/arbiter/pull/894))
- release ([#890](https://github.com/0xethsign/arbiter/pull/890))
- attempt to fix release-plz ([#893](https://github.com/0xethsign/arbiter/pull/893))
- update docs ([#891](https://github.com/0xethsign/arbiter/pull/891))
- rename directories ([#889](https://github.com/0xethsign/arbiter/pull/889))
- Submodule workspace ([#888](https://github.com/0xethsign/arbiter/pull/888))
- release ([#879](https://github.com/0xethsign/arbiter/pull/879))
- Engine/world from config ([#882](https://github.com/0xethsign/arbiter/pull/882))
- Docs/examples ([#881](https://github.com/0xethsign/arbiter/pull/881))
- release ([#878](https://github.com/0xethsign/arbiter/pull/878))
- bump arbiter-core
- workflow ([#876](https://github.com/0xethsign/arbiter/pull/876))
- bump to revm 5.0.0 ([#871](https://github.com/0xethsign/arbiter/pull/871))
- *(deps)* bump chrono from 0.4.33 to 0.4.34 ([#874](https://github.com/0xethsign/arbiter/pull/874))
- *(deps)* bump thiserror from 1.0.56 to 1.0.57 ([#873](https://github.com/0xethsign/arbiter/pull/873))
- remove `PhantomData` ([#868](https://github.com/0xethsign/arbiter/pull/868))
- Crates ([#867](https://github.com/0xethsign/arbiter/pull/867))
- release ([#729](https://github.com/0xethsign/arbiter/pull/729))
- simplify stream interface ([#866](https://github.com/0xethsign/arbiter/pull/866))
- migrate to anyhow::Result ([#864](https://github.com/0xethsign/arbiter/pull/864))
- make machine pub ([#862](https://github.com/0xethsign/arbiter/pull/862))
- *(deps)* bump polars from 0.36.2 to 0.37.0 ([#818](https://github.com/0xethsign/arbiter/pull/818))
- *(deps)* bump tempfile from 3.9.0 to 3.10.0 ([#844](https://github.com/0xethsign/arbiter/pull/844))
- remove codecov ([#860](https://github.com/0xethsign/arbiter/pull/860))
- *(deps)* bump thiserror from 1.0.55 to 1.0.56 ([#850](https://github.com/0xethsign/arbiter/pull/850))
- *(deps)* bump async-trait from 0.1.76 to 0.1.77 ([#849](https://github.com/0xethsign/arbiter/pull/849))
- refactor arbiter-core ([#858](https://github.com/0xethsign/arbiter/pull/858))
- add `arbiter-engine` error handling ([#852](https://github.com/0xethsign/arbiter/pull/852))
- documentation  refactor 🌱 ([#847](https://github.com/0xethsign/arbiter/pull/847))
- engine::new() visibility  ([#854](https://github.com/0xethsign/arbiter/pull/854))
- mdbook contributions for new crates ([#845](https://github.com/0xethsign/arbiter/pull/845))
- Simulation Configs ([#843](https://github.com/0xethsign/arbiter/pull/843))
- *(deps)* bump tokio from 1.35.1 to 1.36.0
- Merge pull request [#837](https://github.com/0xethsign/arbiter/pull/837) from primitivefinance/dependabot/cargo/config-0.14.0
...
- Merge pull request [#820](https://github.com/0xethsign/arbiter/pull/820) from primitivefinance/engine/refactor-behaviors
- spellcheck
...
- save
- Merge pull request [#816](https://github.com/0xethsign/arbiter/pull/816) from primitivefinance/dependabot/cargo/chrono-0.4.33
...
- Update README.md
- Update mdbook.yml
- Merge pull request [#813](https://github.com/0xethsign/arbiter/pull/813) from primitivefinance/documentation-additions
- remove preprocessor
- now all pass?
...
- restructure
- save
- Merge pull request [#807](https://github.com/0xethsign/arbiter/pull/807) from primitivefinance/dependabot/cargo/clap-4.4.18
- Merge pull request [#806](https://github.com/0xethsign/arbiter/pull/806) from primitivefinance/dependabot/cargo/proc-macro2-1.0.78
...
- Merge pull request [#782](https://github.com/0xethsign/arbiter/pull/782) from primitivefinance/dependabot/cargo/clap-4.4.14
- Merge pull request [#781](https://github.com/0xethsign/arbiter/pull/781) from primitivefinance/dependabot/cargo/revm-30bbcdf
- Merge pull request [#780](https://github.com/0xethsign/arbiter/pull/780) from primitivefinance/dependabot/cargo/proc-macro2-1.0.76
...
- Merge pull request [#775](https://github.com/0xethsign/arbiter/pull/775) from primitivefinance/dependabot/cargo/proc-macro2-1.0.75
- Merge pull request [#774](https://github.com/0xethsign/arbiter/pull/774) from primitivefinance/dependabot/cargo/clap-4.4.13
- Merge pull request [#773](https://github.com/0xethsign/arbiter/pull/773) from primitivefinance/dependabot/cargo/syn-2.0.43
- *(deps)* bump syn from 2.0.42 to 2.0.43
- Merge pull request [#770](https://github.com/0xethsign/arbiter/pull/770) from primitivefinance/dependabot/cargo/tokio-1.35.1
- Merge pull request [#771](https://github.com/0xethsign/arbiter/pull/771) from primitivefinance/dependabot/cargo/futures-0.3.30
...
- Update tests.rs
- Update lint.yaml
- Revert "Merge pull request [#725](https://github.com/0xethsign/arbiter/pull/725) from quidproquoo/migrate-alloy"
...
- Merge pull request [#719](https://github.com/0xethsign/arbiter/pull/719) from primitivefinance/remove_wad
...
- release
- Merge pull request [#700](https://github.com/0xethsign/arbiter/pull/700) from primitivefinance/feat/client-label
- ignore changelog
- cargo lock
- release
...
- release-plz
- Update README.md
- Merge pull request [#693](https://github.com/0xethsign/arbiter/pull/693) from primitivefinance/enhance/logging
- clippy
- Merge branch 'main' into enhance/logging
- Merge pull request [#691](https://github.com/0xethsign/arbiter/pull/691) from primitivefinance/dependabot/cargo/toml-0.8.8
- Merge pull request [#672](https://github.com/0xethsign/arbiter/pull/672) from primitivefinance/outputfile_optionality
...
- Merge pull request [#665](https://github.com/0xethsign/arbiter/pull/665) from primitivefinance/arbiter_config
- Merge pull request [#679](https://github.com/0xethsign/arbiter/pull/679) from primitivefinance/dependabot/cargo/syn-2.0.39
...
- Merge pull request [#658](https://github.com/0xethsign/arbiter/pull/658) from primitivefinance/dependabot/cargo/tempfile-3.8.1
...
- fmt
- release
- Merge pull request [#656](https://github.com/0xethsign/arbiter/pull/656) from primitivefinance/colin/fix-event-logger
- rm printlns
- fmt
- create valid json
...
- Merge pull request [#642](https://github.com/0xethsign/arbiter/pull/642) from primitivefinance/dependabot/cargo/clap-4.4.7
- *(deps)* bump tracing from 0.1.39 to 0.1.40
- release
- cargo lock
- *(deps)* update toml requirement from =0.8.2 to =0.8.4
- release
- Merge pull request [#633](https://github.com/0xethsign/arbiter/pull/633) from primitivefinance/md_book
- Merge pull request [#634](https://github.com/0xethsign/arbiter/pull/634) from primitivefinance/fix/arbiter-bind-output
- release
- code spell
- clippy
- tests pass
- 🧪
- Merge pull request [#618](https://github.com/0xethsign/arbiter/pull/618) from primitivefinance/feat/release_pls
- bump version
- forking EOA
...
- Merge pull request [#578](https://github.com/0xethsign/arbiter/pull/578) from primitivefinance/dependabot/cargo/clap-eq-4.4.6
...
- Merge pull request [#582](https://github.com/0xethsign/arbiter/pull/582) from primitivefinance/dependabot/cargo/thiserror-eq-1.0.49
- *(deps)* update thiserror requirement from =1.0.47 to =1.0.49
- *(deps)* update RustQuant requirement in /arbiter-core
- Merge pull request [#567](https://github.com/0xethsign/arbiter/pull/567) from primitivefinance/dependabot/cargo/assert_cmd-eq-2.0.12
- Merge pull request [#566](https://github.com/0xethsign/arbiter/pull/566) from primitivefinance/dependabot/cargo/syn-eq-2.0.37
- Merge pull request [#565](https://github.com/0xethsign/arbiter/pull/565) from primitivefinance/dependabot/cargo/toml-eq-0.8.1
- Merge pull request [#569](https://github.com/0xethsign/arbiter/pull/569) from primitivefinance/dependabot/cargo/arbiter-core/anyhow-eq-1.0.75
...
- Update README.md
- Merge pull request [#510](https://github.com/0xethsign/arbiter/pull/510) from primitivefinance/dependabot/cargo/RustQuant-0.0.31
- patch version
...
- Merge pull request [#448](https://github.com/0xethsign/arbiter/pull/448) from primitivefinance/fix-pull-request-template
...
- Merge pull request [#422](https://github.com/0xethsign/arbiter/pull/422) from primitivefinance/test-cleanup
...
- sim mod
- sim mod
- Fixes issue [#234](https://github.com/0xethsign/arbiter/pull/234)
...
- Merge pull request [#224](https://github.com/0xethsign/arbiter/pull/224) from primitivefinance/waylon/versioning
- name change
...
- Merge pull request [#122](https://github.com/0xethsign/arbiter/pull/122) from primitivefinance/0xJepsen-patch-1
- Update lib.rs
...
- Merge pull request [#108](https://github.com/0xethsign/arbiter/pull/108) from primitivefinance/virtual-revm
...
- Merge pull request [#67](https://github.com/0xethsign/arbiter/pull/67) from primitivefinance/number-calc
- typos
- Colins feedback
...
- Comments
- Update README.md
- Merge pull request [#14](https://github.com/0xethsign/arbiter/pull/14) from primitivefinance/refactor-after-user-input-parsing
- Rust CLI
- Tests
...
- Pool search
- Provider + factory
- Merge pull request [#8](https://github.com/0xethsign/arbiter/pull/8) from primitivefinance/price-math
